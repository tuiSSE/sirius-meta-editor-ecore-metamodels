...
/**
 * This is the item provider adapter for a {@link de.e4sm.tuilmenau.sse.architecture.model.architecture.ModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelElementItemProvider 
	...
	protected void addIsAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelElement_isAbstract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_isAbstract_feature", "_UI_ModelElement_type"),
				 ArchitecturePackage.Literals.MODEL_ELEMENT__IS_ABSTRACT,
				 true,
				 false,
				 false,
	...
	protected void addIsAPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelElement_isA_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_isA_feature", "_UI_ModelElement_type"),
				 ArchitecturePackage.Literals.MODEL_ELEMENT__IS_A,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturePackage.Literals.MODEL_ELEMENT__PROPERTIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.MODEL_ELEMENT__PROPERTIES,
				 ArchitectureFactory.eINSTANCE.createProperty()));
	}
