...
/**
 * This is the item provider adapter for a {@link de.e4sm.tuilmenau.sse.architecture.model.architecture.Metamodel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetamodelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturePackage.Literals.METAMODEL__URI,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Metamodel)object).getUri();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Metamodel.class)) {
			case ArchitecturePackage.METAMODEL__URI:
