...
/**
 * This is the item provider adapter for a {@link de.e4sm.tuilmenau.sse.architecture.model.architecture.Behavior} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturePackage.Literals.BEHAVIOR__PRECONDITION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Behavior_body_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Behavior_body_feature", "_UI_Behavior_type"),
				 ArchitecturePackage.Literals.BEHAVIOR__BODY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturePackage.Literals.BEHAVIOR__POST_CONDITION,
				 true,
				 false,
				 true,
				 null,
