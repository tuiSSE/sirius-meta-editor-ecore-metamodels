...
/**
 * This is the item provider adapter for a {@link de.e4sm.tuilmenau.sse.architecture.model.architecture.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider extends ModelElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BlockStyle_backgroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockStyle_backgroundColor_feature", "_UI_BlockStyle_type"),
				 ArchitecturePackage.Literals.BLOCK_STYLE__BACKGROUND_COLOR,
				 true,
				 false,
				 false,
	...
	protected void addLabelColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BlockStyle_labelColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockStyle_labelColor_feature", "_UI_BlockStyle_type"),
				 ArchitecturePackage.Literals.BLOCK_STYLE__LABEL_COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addBorderColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BlockStyle_borderColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BlockStyle_borderColor_feature", "_UI_BlockStyle_type"),
				 ArchitecturePackage.Literals.BLOCK_STYLE__BORDER_COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturePackage.Literals.ITEM__OUTGOING);
			childrenFeatures.add(ArchitecturePackage.Literals.ITEM__INCOMING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ITEM__OUTGOING,
				 ArchitectureFactory.eINSTANCE.createConnection()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ITEM__INCOMING,
				 ArchitectureFactory.eINSTANCE.createConnection()));
	}
