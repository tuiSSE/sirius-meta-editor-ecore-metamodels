...
/**
 * This is the item provider adapter for a {@link de.e4sm.tuilmenau.sse.architecture.model.architecture.Diagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramItemProvider 
	...
	protected void addElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diagram_elements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diagram_elements_feature", "_UI_Diagram_type"),
				 ArchitecturePackage.Literals.DIAGRAM__ELEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diagram_level_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diagram_level_feature", "_UI_Diagram_type"),
				 ArchitecturePackage.Literals.DIAGRAM__LEVEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Diagram.class)) {
			case ArchitecturePackage.DIAGRAM__NAME:
			case ArchitecturePackage.DIAGRAM__DESCRIPTION:
			case ArchitecturePackage.DIAGRAM__VERSION:
			case ArchitecturePackage.DIAGRAM__LEVEL:
