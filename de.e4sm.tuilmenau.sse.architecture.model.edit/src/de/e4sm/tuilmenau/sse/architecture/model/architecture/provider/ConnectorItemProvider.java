...
/**
 * This is the item provider adapter for a {@link de.e4sm.tuilmenau.sse.architecture.model.architecture.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LineStyle_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LineStyle_width_feature", "_UI_LineStyle_type"),
				 ArchitecturePackage.Literals.LINE_STYLE__WIDTH,
				 true,
				 false,
				 false,
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LineStyle_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LineStyle_color_feature", "_UI_LineStyle_type"),
				 ArchitecturePackage.Literals.LINE_STYLE__COLOR,
				 true,
				 false,
				 false,
	...
	protected void addLineStylePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LineStyle_lineStyle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LineStyle_lineStyle_feature", "_UI_LineStyle_type"),
				 ArchitecturePackage.Literals.LINE_STYLE__LINE_STYLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDistinctPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_distinct_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_distinct_feature", "_UI_Connector_type"),
				 ArchitecturePackage.Literals.CONNECTOR__DISTINCT,
				 true,
				 false,
				 false,
