...
/**
 * This is the item provider adapter for a {@link de.e4sm.tuilmenau.sse.architecture.model.architecture.Architecture} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchitectureItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommonsPackage.Literals.NAMED_ELEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommonsPackage.Literals.NAMED_ELEMENT__VERSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturePackage.Literals.ARCHITECTURE__DIAGRAMS);
			childrenFeatures.add(ArchitecturePackage.Literals.ARCHITECTURE__MODELELEMENTS);
			childrenFeatures.add(ArchitecturePackage.Literals.ARCHITECTURE__IMPORTS);
			childrenFeatures.add(ArchitecturePackage.Literals.ARCHITECTURE__BEHAVIORS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__DIAGRAMS,
				 ArchitectureFactory.eINSTANCE.createDiagram()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__MODELELEMENTS,
				 ArchitectureFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__MODELELEMENTS,
				 ArchitectureFactory.eINSTANCE.createContainer()));
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__MODELELEMENTS,
				 ArchitectureFactory.eINSTANCE.createAddOn()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__MODELELEMENTS,
				 ArchitectureFactory.eINSTANCE.createEdge()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__MODELELEMENTS,
				 ArchitectureFactory.eINSTANCE.createRangeConnection()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__IMPORTS,
				 ArchitectureFactory.eINSTANCE.createMetamodel()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__BEHAVIORS,
				 ArchitectureFactory.eINSTANCE.createBehavior()));
	}
