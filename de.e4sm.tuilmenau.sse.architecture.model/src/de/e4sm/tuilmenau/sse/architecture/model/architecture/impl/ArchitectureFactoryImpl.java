...
public class ArchitectureFactoryImpl extends EFactoryImpl implements ArchitectureFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ArchitecturePackage.DIAGRAM: return createDiagram();
			case ArchitecturePackage.NODE: return createNode();
			case ArchitecturePackage.CONTAINER: return createContainer();
			case ArchitecturePackage.PORT: return createPort();
			case ArchitecturePackage.ADD_ON: return createAddOn();
			case ArchitecturePackage.ARCHITECTURE: return createArchitecture();
			case ArchitecturePackage.EDGE: return createEdge();
			case ArchitecturePackage.RANGE_CONNECTION: return createRangeConnection();
			case ArchitecturePackage.PROPERTY: return createProperty();
			case ArchitecturePackage.METAMODEL: return createMetamodel();
			case ArchitecturePackage.CONNECTION: return createConnection();
			case ArchitecturePackage.BEHAVIOR: return createBehavior();
			default:
	 ...
	 */
	@Override
	public de.e4sm.tuilmenau.sse.architecture.model.architecture.Container createContainer() {
	 ...
	 */
	@Override
	public RangeConnection createRangeConnection() {
		RangeConnectionImpl rangeConnection = new RangeConnectionImpl();
