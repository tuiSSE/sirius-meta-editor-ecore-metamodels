...
/**
 * This is the item provider adapter for a {@link de.e4sm.tuilmenau.sse.architectureimpl.model.architectureImpl.ModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitectureImplPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModelElement.class)) {
			case ArchitectureImplPackage.MODEL_ELEMENT__NAME:
	...
	public ResourceLocator getResourceLocator() {
		return ArchitectureImplEditPlugin.INSTANCE;
	}
